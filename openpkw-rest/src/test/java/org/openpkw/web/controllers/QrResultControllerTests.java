...
@ContextConfiguration(classes = {TestJpaConfig.class, MVCConfig.class, TestAppConfig.class, SecurityConfig.class, OAuth2ServerConfiguration.class})
@WebAppConfiguration
public class QrResultControllerTests {
    ...
    private static final String ADMIN_USER = "admin@openpkw.pl";
    ...
    private void prepareData() {
        ...
        districtCommittee.setDistrictCommitteeNumber(19);
